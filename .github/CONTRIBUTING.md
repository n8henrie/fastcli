...
Report bugs at <https://github.com/n8henrie/fastcli/issues>.
...
fastcli could always use more documentation,
whether as part of the official fastcli docs,
in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
<https://github.com/n8henrie/fastcli/issues>.
...
Ready to contribute? Here's how to set up fastcli
for local development.

1.  Fork the fastcli repo on GitHub.
1.  Clone your fork locally:

        $ git clone git@github.com:your_name_here/fastcli.git
